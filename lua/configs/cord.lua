local options = {
  ...
  log_level = "debug", -- One of 'trace', 'debug', 'info', 'warn', 'error', 'off'
  timer = {
  ...
  editor = {
    ...
    client = "nvchad", -- vim, neovim, lunarvim, nvchad, astronvim or your application's client id
    tooltip = "The chad's editor", -- Text to display when hovering over the editor's image
  },
  display = {
